                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary boxStyle">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Informações para cadastro do Novo Paciente</h3>
                                ...
                                <div class="box-body formBody">
                                    <div class="row">
                                        ...
                                        <?php if (userPermission($_SESSION['userId']) == 15) { ?>
                                            <div class="col-xs-2">
                                                <div class="form-group">
                                                    <label>Médico Responsável</label>
                                                    <font style="color: red; font-size: 14px;"><b>*</b></font></label><br>
                                                    <select class="form-control select2 inputDotStyle" name="" id="" style="width: 100%;">
                                                        <option value="">Selecione um médico</option>
                                                        <?php
                                                        $queryDoc = $mySQL->sql("SELECT userId, userName FROM users WHERE userType = 'doctor' ");
                                                        while ($dataDoc = mysqli_fetch_array($queryDoc)) {
                                                        ?>
                                                            <option value="<?= $dataDoc['userId'] ?>"><?= $dataDoc['userName'] ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                                        ...
                                        <?php } else if (userPermission($_SESSION['userId'] == 2)) { ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control inputDotStyle" style="text-transform: uppercase;" name="pacientsObs" id="userObs" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>

                                        <div class="col-xs-12">
                                            <input type="hidden" name="userId" id="userId" value="<?= $userId ?>">
                                            <input type="hidden" name="userType" id="userType" value="pacient">
                                            <button type="submit" class="btn btn-info pull-right buttonDotStyleFull">
                                                <i class="glyphicon glyphicon-floppy-save"></i>
                                                &nbsp;<b>Salvar Informações do Paciente</b>
                                            </button>
                                        </div>
                                    </div><!-- /.row-->
                                </div><!--/.col (left) -->
